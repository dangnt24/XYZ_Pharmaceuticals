	...
	if ($('#passwordInput').length > 0) {
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength < 8) {
				...
				passwordInfo.innerHTML = '<img src="/assets/img/icon/angry.svg" style="width: 15px;" class="me-2"> ' + "Weak. Must contain at least 8 characters";
			}
		}
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && (poorPassword || weakPassword || strongPassword)) {
				...
				passwordInfo.innerHTML = '<img src="/assets/img/icon/anguish.svg" style="width: 15px;" class="me-2">' + "Average. Must contain at least 1 character or number";
			} else {
		...
		function strongPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && poorPassword && (weakPassword || strongPassword)) {
				...
				passwordStrength.classList.remove("heavy-active");
				passwordInfo.innerHTML = '<img src="/assets/img/icon/smile.svg" style="width: 15px;" class="me-2">' + "Almost there. Must contain a special character";
		...
		function heavyPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword) {
			if (passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword) {
				...
				passwordInfo.innerHTML = '<img src="/assets/img/icon/smile.svg" style="width: 15px;" class="me-2">' + "Excellent! You have a strong password.";
	...
	if ($('#passwordInputs').length > 0) {
		...
		passwordInput1.oninput = function () {
			...
			if (passwordValue1 != "") {
				...
				if (whitespace1) {
					...
					poorPasswordStrength(passwordLength1, poor1Password1, weak1Password1, strong1Password1);
					weakPasswordStrength(passwordLength1, poor1Password1, weak1Password1, strong1Password1);
					strongPasswordStrength(passwordLength1, poor1Password1, weak1Password1, strong1Password1);
					heavypasswordStrength(passwordLength1, poor1Password1, weak1Password1, strong1Password1);
				}
		...
		function poor1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 < 8) {
				...
				passwordInfos.innerHTML = '<img src="/assets/img/icon/angry.svg" class="me-2"> style="width: 15px;"' + "Yếu. Phải chứa ít nhất 8 ký tự";
			}
		}
		...
		function weak1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 >= 8 && (poor1Password1 || weak1Password1 || strong1Password1)) {
				...
				passwordInfos.innerHTML = '<img src="/assets/img/icon/anguish.svg" class="me-2"> style="width: 15px;"' + "Trung bình. Phải chứa ít nhất 1 chữ cái hoặc số";
			} else {
		...
		function strong1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 >= 8 && poor1Password1 && (weak1Password1 || strong1Password1)) {
				...
				passwordStrength1.classList.remove("heavy-active");
				passwordInfos.innerHTML = '<img src="/assets/img/icon/smile.svg" class="me-2"> style="width: 15px;"' + "Gần đúng. Phải chứa ký tự đặc biệt";
		...
		function heavy1passwordStrength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1) {
			if (passwordLength1 >= 8 && (poor1Password1 && weak1Password1) && strong1Password1) {
				...
				passwordInfos.innerHTML = '<img src="/assets/img/icon/smile.svg" class="me-2"> style="width: 15px;"' + "Tuyệt vời! Mật khẩu của bạn rất an toàn.";
